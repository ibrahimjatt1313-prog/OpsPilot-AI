# 🚀 OpsPilot AI – AI-Powered Operations Intelligence Assistant

OpsPilot AI is an AI-powered operations assistant built for the AI Infra Summit Hackathon 2026. It helps operations teams turn real-world operational problems into actionable decisions. Users describe an operational situation, and the system uses Gemini AI to identify the situation, assess risk and priority, identify possible causes, and recommend practical next actions.

---

## 🌐 Live Demo
* [View Live Application](https://ops-pilot-ai-jade.vercel.app/)
...
3. Gemini AI evaluates and analyzes the operational situation.
4. The system generates:
   ...
   * Possible cause
   * Recommended actions
5. The result is displayed in the AI Analysis dashboard, and previous analyses are stored in the browser history.
